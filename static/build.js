...
socket.on('create-channel', (data) => {
  console.log('channel-create-data', data);
});
...
socket.on('leave-channel', (data) => {
  console.log('channel-leave-data', data);
});

socket.on('destroy-channel', (data) => {
  console.log('channel-destroy-data', data);
});
...
$(() => {
  var token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6InNvdm9ybyIsImRpc3BsYXlOYW1lIjoi7IaM67O066GcMTEzIiwicmF0aW5nIjoic3VwZXIiLCJpYXQiOjE1MzM3MTg4NDksImV4cCI6MTUzMzc1NDg0OX0.HbeFrLZXmqgczI-4kqjUxzMgahvOXQyUo5kU_PrlaTI';
  $('#btn_create').on('click', () => {
